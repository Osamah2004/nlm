    ...
    return (
      <div className="w-170 h-125 overflow-y-auto nowheel">
        ...
        <details className="details">
          ...
          <p className="text-gray-500 text-xs italic mb-4">Your modifications won't be saved here, so copy the zomboss' code before leaving the popup</p>
          <div className="w-full grid grid-cols-2 gap-1 border-b pb-1 h-26 overflow-y-auto">
            <button className="button" onClick={() => modalFunction(<ZombossModal ZombossTypeName={"egypt"}/>)}>egypt</button>
            <button className="button" onClick={() => modalFunction(<ZombossModal ZombossTypeName={"pirate"}/>)}>pirate</button>
            <button className="button" onClick={() => modalFunction(<ZombossModal ZombossTypeName={"cowboy"}/>)}>cowboy</button>
            <button className="button" onClick={() => modalFunction(<ZombossModal ZombossTypeName={"future"}/>)}>future</button>
        ...
        <details className="details">
          ...
          <div className="w-full block border-b pb-1 h-40 overflow-y-auto">
              ...
              <NumberInput min={0} step={0.1} label={"SunCountdownIncreasePerSun"}/>
        ...
        <TextInput placeholder={'\\n for breakline'} default={sessionStorage.getItem('Custom objective text') || null} label={"Custom objective text"} full={true}/>
        <div className="my-2"/>
